 ...
 */
package com.example.finalprojectpawsoto;

import com.example.finalprojectpawsoto.exceptions.NonexistentEntityException;
import com.example.finalprojectpawsoto.exceptions.PreexistingEntityException;
...
public class MenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_finalprojectpawsoto_jar_0.0.1-SNAPSHOTPU");
